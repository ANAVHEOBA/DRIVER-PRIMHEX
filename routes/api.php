...
Route::post('/rides/accept', [RideController::class, 'accept'])->middleware('auth:sanctum');
Route::post('/rides/reject', [RideController::class, 'reject'])->middleware('auth:sanctum');

//RIDE MATCHING
Route::get('/rides/match', [RideController::class, 'match'])
...
//START AND COMPLETE
Route::post('/rides/start', [RideController::class, 'start'])->middleware('auth:sanctum');
Route::post('/rides/complete', [RideController::class, 'complete'])->middleware('auth:sanctum');

//CALCULATE RIDES
Route::get('/rides/fare', [RideController::class, 'calculateFare'])->middleware('auth:sanctum');

//UPDATE LOCATION
Route::patch('/rides/location', [RideController::class, 'updateLocation'])->middleware('auth:sanctum');
